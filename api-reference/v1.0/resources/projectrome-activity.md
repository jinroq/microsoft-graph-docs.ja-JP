...
|[アクティビティを削除する](../api/projectrome-delete-activity.md) | コンテンツはありません | そのユーザーの指定したアクティビティをアプリから削除します。|
...
|id | 文字列 | サーバーによって生成された ID。 URL アドレス指定に使用されます。|
...
|リレーションシップ | 型 | 説明|
|:------------|:-----|:-----------|
|historyItems| [Activityhistory item](../resources/projectrome-historyitem.md)コレクション | 省略可能。 NavigationProperty/コンテインメント;アクティビティの履歴アイテムへのナビゲーションプロパティ。|
