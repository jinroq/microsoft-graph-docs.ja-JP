...
|appleBulkWithUser|3|ユーザーチャレンジを使って Apple の一括登録を行います。 (DEP、Apple Configurator)|
|appleBulkWithoutUser|4|ユーザーチャレンジを使わないで Apple の一括登録を行います。 (DEP、Apple Configurator、モバイルコンフィギュレーター)|
