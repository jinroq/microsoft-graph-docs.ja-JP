...
Microsoft Graph では、アクセス許可によってリソースへのアクセスを制御します。 Reports リソースにアクセスするには、アクセス許可を指定する必要があります。 通常は Azure Active Directory (Azure AD) ポータルでアクセス許可を指定します。 詳細については、「[Microsoft Graph のアクセス許可のリファレンス](../../../concepts/permissions_reference.md)」および「[Reports のアクセス許可](../../../concepts/permissions_reference.md#reports-permissions)」を参照してください。
