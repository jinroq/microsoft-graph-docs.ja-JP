...
|プロパティ|型|説明|
|:---|:---|:---|
|id|文字列型 (String)|エンティティのキー。 これは読み取り専用で、自動生成されます。 [roleAssignment](../resources/intune_rbac_roleassignment.md) から継承します|
|displayName|文字列型 (String)|ロール割り当ての表示名またはフレンドリ名。 [roleAssignment](../resources/intune_rbac_roleassignment.md) から継承します|
|description|文字列型 (String)|ロール割り当ての説明。 [roleAssignment](../resources/intune_rbac_roleassignment.md) から継承します|
