...
|[ImportedWindowsAutopilotDeviceIdentityUpload を削除します。](../api/intune_enrollment_importedwindowsautopilotdeviceidentityupload_delete.md)|なし|の[importedWindowsAutopilotDeviceIdentityUpload](../resources/intune_enrollment_importedwindowsautopilotdeviceidentityupload.md)を削除します。|
