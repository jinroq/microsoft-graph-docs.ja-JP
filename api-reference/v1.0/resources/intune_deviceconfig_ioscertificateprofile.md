...
|メソッド|戻り値の型|説明|
|:---|:---|:---|
|[iosCertificateProfiles のリスト](../api/intune_deviceconfig_ioscertificateprofile_list.md)|[iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md) コレクション|[iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md) オブジェクトのプロパティとリレーションシップをリストします。|
|[iosCertificateProfile の取得](../api/intune_deviceconfig_ioscertificateprofile_get.md)|[iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md)|[iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md) オブジェクトのプロパティとリレーションシップを読み取ります。|
