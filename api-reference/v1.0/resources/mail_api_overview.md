...
| out-of-office のような、他の受信者の特別な状態のメール ヒントを取得します。 | [ユーザー](../resources/user.md)、 <br> [mailTips](../resources/mailtips.md) | [メール ヒントを取得します。](../api/user_getmailtips.md) |
| **メールとフォルダーの管理** | | |
...
| **アプリ開発** | | |
| メッセージのインターネット メッセージのヘッダーとしてカスタム アプリケーションのデータを追加する | [メッセージ](../resources/message.md) | メッセージの **internetMessageHeaders** プロパティにカスタム データを追加する |
...
メール API によって、ユーザーと連携するための新しい方法が開かれます。
