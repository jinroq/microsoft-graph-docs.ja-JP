...
|色|CategoryColor|カテゴリを特徴付ける、あらかじめ設定された色の定数は、事前定義された 25色のいずれか 1 つにマッピングされています。 次の注を参照してください。 |
...
|[削除](../api/outlookcategory_delete.md) | なし |指定した **outlookCategory** オブジェクトを削除します。 |
