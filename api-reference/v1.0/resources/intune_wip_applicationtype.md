# <a name="applicationtype-enum-type"></a><span data-ttu-id="a49de-101">applicationType 列挙型</span><span class="sxs-lookup"><span data-stu-id="a49de-101">applicationType enum type</span></span>
