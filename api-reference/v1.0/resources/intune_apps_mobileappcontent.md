# <a name="mobileappcontent-resource-type"></a><span data-ttu-id="7df87-101">mobileAppContent リソースの種類</span><span class="sxs-lookup"><span data-stu-id="7df87-101">mobileAppContent resource type</span></span>
