...
|themeColor|[rgbColor](../resources/intune_onboarding_rgbcolor.md)|会社のポータル アプリケーションと Web ポータルで使用する主要なテーマの色。|
|showLogo|Boolean|管理者が指定したロゴ画像が表示されるかどうかを表すブール値。|
|lightBackgroundLogo|[mimeContent](../resources/intune_onboarding_mimecontent.md)|ロゴの背景色が明るいポータル サイト アプリに表示されるロゴ画像。|
|darkBackgroundLogo|[mimeContent](../resources/intune_onboarding_mimecontent.md)|ロゴの背景色が暗いポータル サイト アプリに表示されるロゴ画像。|
