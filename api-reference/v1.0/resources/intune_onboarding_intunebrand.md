...
|lightBackgroundLogo|[mimeContent](../resources/intune_shared_mimecontent.md)|ロゴの背景色が明るいポータル サイト アプリに表示されるロゴ画像。|
|darkBackgroundLogo|[mimeContent](../resources/intune_shared_mimecontent.md)|ロゴの背景色が暗いポータル サイト アプリに表示されるロゴ画像。|
