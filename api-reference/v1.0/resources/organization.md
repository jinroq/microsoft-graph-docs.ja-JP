...
| 国                              | 文字列                                                            | 組織の住所の国/地域名                                                                                                                                                                                                                              |
| countryLetterCode                    | 文字列                                                            | 組織の国/地域の略称                                                                                                                                                                                                                                     |
...
| preferredLanguage                    | 文字列                                                            | 組織の優先言語。 ISO 639-1 コードに従う必要があります (例: "en")。                                                                                                                                                                                         |
