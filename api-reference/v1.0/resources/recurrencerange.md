...
|:---------------|:--------|:--------|:--------|:----------|
|終了日が指定された期間 | `endDate` | **startDate** と **endDate** の範囲内の、対応する定期的なパターンに適合するすべての日に、イベントが繰り返されます。 | 2017 年 6 月 1 日から 2017 年 6 月 15 日の期間で、イベントを繰り返します。 | **type**、**startDate**、**endDate** | 
