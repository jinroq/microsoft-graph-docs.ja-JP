...
|sectionGroups|[SectionGroup](sectiongroup.md) collection|セクション内のセクショングループ。 読み取り専用です。 Null 許容型。|
|セクション|[OnenoteSection](section.md) コレクション|セクショングループ内のセクション。 読み取り専用です。 Null 許容型。|
