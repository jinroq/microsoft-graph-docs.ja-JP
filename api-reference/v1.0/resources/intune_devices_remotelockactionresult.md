...
|actionState|[actionState](../resources/intune_devices_actionstate.md)|[DeviceActionResult](../resources/intune_devices_deviceactionresult.md)から継承されたアクションの状態です。 使用可能な値は`none`、`pending`、`canceled`、`active`、`done`、`failed`、`notSupported` です。|
...
|unlockPin|文字列|クライアントをロック解除するためのピン|
