...
| $skiptoken | string | 前の**デルタ**関数呼び出しの `nextLink` URL 内で返された[状態トークン](../../../concepts/delta_query_overview.md)で、同じカレンダー ビュー内に追跡すべき変更が他にもあることを示しています。 |
...
カレンダー ビュー内の変更を追跡するには、1 回以上の**デルタ**関数呼び出しを作成し、適切な[状態トークン](../../../concepts/delta_query_overview.md)を使用して、前回のデルタ クエリ以降になされた一連の増分変更を取得します。 
...
- [カレンダー内のイベントの増分の変更を取得する](../../../concepts/delta_query_events.md)
