...
この API を使用して、新しい TableRow を作成します。
...
要求本文で、[TableRow](../resources/tablerow.md) オブジェクトの JSON 表記を指定します。

## <a name="response"></a>応答

成功した場合、このメソッドは `201 Created` 応答コードと、応答本文で [TableRow](../resources/tablerow.md) オブジェクトを返します。
