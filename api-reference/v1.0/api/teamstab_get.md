...
> 現在、[委任されたアクセス許可](../../../concepts/permissions_reference.md)をのみがこの操作に対してサポートされています。
...
このメソッドは、$select をサポートし、$ は、応答をカスタマイズするために[OData クエリ パラメーター](../../../concepts/query_parameters.md)を展開します。
