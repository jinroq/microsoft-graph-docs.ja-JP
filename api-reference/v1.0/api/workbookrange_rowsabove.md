...
| パラメーター    | 型   |説明|
|:---------------|:--------|:----------|
|カウント|Int32|省略可能。結果の範囲に含める行の数です。通常、正の数値を使用して現在の範囲外に範囲を作成します。負の数値を使用して、現在の範囲内に範囲を作成することもできます。既定値は 1 です。|
...
オプションの `count` パラメーターなしで呼び出された場合、この関数は、範囲の上の行を 1 つ返します。
