# <a name="update-chartfont"></a>chartfont を更新する
...
|underline|string|フォントに適用する下線の種類です。 指定できる値は、 `None`、`Single` です。|

## <a name="response"></a>応答

成功した場合、このメソッドは `200 OK` 応答コードを返し、応答本文で [WorkbookChartFont](../resources/chartfont.md) オブジェクトを更新します。
## <a name="example"></a>例
##### <a name="request"></a>要求
以下は、要求の例です。
<!-- {
