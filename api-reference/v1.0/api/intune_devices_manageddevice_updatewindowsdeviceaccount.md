...
|プロパティ|型|説明|
|:---|:---|:---|
|updateWindowsDeviceAccountActionParameter|[updateWindowsDeviceAccountActionParameter](../resources/intune_devices_updatewindowsdeviceaccountactionparameter.md)|まだ文書化されていません|
