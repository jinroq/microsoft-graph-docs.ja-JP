...
|プロパティ|型|説明|
|:---|:---|:---|
|enrollmentConfigurationAssignments|[enrollmentConfigurationAssignment](../resources/intune_onboarding_enrollmentconfigurationassignment.md) コレクション|まだ文書化されていません|
