...
新規作成またはアプリケーションが既存のユーザー アクティビティを交換します。 1 つの要求でユーザーの利用状況とその関連する**historyItems**を作成したい場合は、[深い挿入](projectrome_put_activity.md#example-2---deep-insert)を使用できます。
...
要求の本文には、[アクティビティ](../resources/projectrome_activity.md)オブジェクトの JSON の形式を指定します。
...
## <a name="example-2---deep-insert"></a>例 2 - ディープ挿入
