...
[deviceAppManagement](../resources/intune_mam_deviceappmanagement.md) オブジェクトのプロパティとリレーションシップを読み取ります。
...
成功した場合、このメソッドは `200 OK` 応答コードと、応答本文で [deviceAppManagement](../resources/intune_mam_deviceappmanagement.md) オブジェクトを返します。
