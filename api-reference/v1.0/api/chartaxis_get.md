# <a name="get-chartaxis"></a>ChartAxis を取得する

chartAxis オブジェクトのプロパティと関係を取得します。
...
成功した場合、このメソッドは `200 OK` 応答コードと、応答本文で [WorkbookChartAxis](../resources/chartaxis.md) オブジェクトを返します。
## <a name="example"></a>例
##### <a name="request"></a>要求
以下は、要求の例です。
<!-- {
