...
[managedMobileLobApp](../resources/intune_apps_managedmobilelobapp.md) オブジェクトのプロパティとリレーションシップを読み取ります。
...
成功した場合、このメソッドは `200 OK` 応答コードと、応答本文で [managedMobileLobApp](../resources/intune_apps_managedmobilelobapp.md) オブジェクトを返します。
