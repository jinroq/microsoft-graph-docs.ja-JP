...
[deviceManagement](../resources/intune_devices_devicemanagement.md) オブジェクトのプロパティとリレーションシップを読み取ります。
...
成功した場合、このメソッドは `200 OK` 応答コードと、応答本文で [deviceManagement](../resources/intune_devices_devicemanagement.md) オブジェクトを返します。
