...
[androidForWorkSettings](../resources/intune_androidforwork_androidforworksettings.md) オブジェクトのプロパティとリレーションシップを読み取ります。
...
成功した場合、このメソッドは `200 OK` 応答コードと、応答本文で [androidForWorkSettings](../resources/intune_androidforwork_androidforworksettings.md) オブジェクトを返します。
