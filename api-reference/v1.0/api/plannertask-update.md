...
|bucketId|String|タスクが属するバケット id。 バケットは、タスクが存在している計画に含まれている必要があります。 28 文字長で、大文字と小文字の区別があります。 [書式検証](../resources/planner-identifiers-disclaimer.md)はサービスによって行われます。 |
