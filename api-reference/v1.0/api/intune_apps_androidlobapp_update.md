...
[androidLobApp](../resources/intune_apps_androidlobapp.md) オブジェクトのプロパティを更新します。
...
要求本文で、[androidLobApp](../resources/intune_apps_androidlobapp.md) オブジェクトの JSON 表記を指定します。

次の表に、[androidLobApp](../resources/intune_apps_androidlobapp.md) の作成時に必要なプロパティを示します。
...
成功した場合、このメソッドは `200 OK` 応答コードと、更新された [androidLobApp](../resources/intune_apps_androidlobapp.md) オブジェクトを応答本文で返します。
