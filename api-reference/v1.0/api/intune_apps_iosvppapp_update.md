...
[iosVppApp](../resources/intune_apps_iosvppapp.md) オブジェクトのプロパティを更新します。
...
要求本文で、[iosVppApp](../resources/intune_apps_iosvppapp.md) オブジェクトの JSON 表記を指定します。

次の表に、[iosVppApp](../resources/intune_apps_iosvppapp.md) 作成時に必要となるプロパティを示します。
...
成功した場合、このメソッドは `200 OK` 応答コードと、更新された [iosVppApp](../resources/intune_apps_iosvppapp.md) オブジェクトを応答本文で返します。
