# <a name="remove-directory-role-member"></a><span data-ttu-id="31ab7-101">ディレクトリ ロールのメンバーを削除する</span><span class="sxs-lookup"><span data-stu-id="31ab7-101">Remove directory role member</span></span>
