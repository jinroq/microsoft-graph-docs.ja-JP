...
---
# <a name="get-plannertask"></a>Get plannerTask

**plannertask** オブジェクトのプロパティと関係を取得します。
...
成功した場合、このメソッドは `200 OK` 応答コードと、応答本文で [plannerTask](../resources/plannertask.md) オブジェクトを返します。
