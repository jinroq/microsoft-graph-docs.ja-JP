...
[webApp](../resources/intune_apps_webapp.md) オブジェクトのプロパティを更新します。
...
要求本文で、[webApp](../resources/intune_apps_webapp.md) オブジェクトの JSON 表記を指定します。

次の表に、[webApp](../resources/intune_apps_webapp.md) 作成時に必要なプロパティを示します。
...
このメソッドが成功した場合、このメソッドは `200 OK` 応答コードと、更新された [webApp](../resources/intune_apps_webapp.md) オブジェクトを応答本文で返します。
