...
|$search|string|名またはエイリアスで人物を検索します。 ファジー マッチングをサポートします。 パラメーターは、サインインしているユーザーに関連する人の検索のみに機能し、そうでないユーザーに関連する人の検索には機能しません。 その人との電子メールのやり取りから抽出されるトピックスに基づいて人を検索するための `topic` キーワードもサポートしています。 情報と例については、 「[人の関連情報を取得する](../../../concepts/people_example.md#perform-a-fuzzy-search)」の[*あいまい検索を実行する*] セクションを参照してください。 |
