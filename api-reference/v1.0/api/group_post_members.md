...
この API を使用して、**メンバー**のナビゲーション プロパティを通じて Office 365 のグループ、セキュリティ グループ、またはメールが有効なセキュリティ グループにメンバーを追加できます。ユーザーや他のグループを追加できます。重要事項:Office 365 のグループには、ユーザーのみを追加できます。
