# <a name="update-chartdatalabels"></a>chartdatalabels を更新する
...
成功した場合、このメソッドは `200 OK` 応答コードを返し、応答本文で[WorkbookChartDataLabels](../resources/chartdatalabels.md) オブジェクトを更新します。
## <a name="example"></a>例
##### <a name="request"></a>要求
以下は、要求の例です。
<!-- {
