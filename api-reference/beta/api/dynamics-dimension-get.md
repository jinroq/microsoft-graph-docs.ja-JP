...
---
# <a name="get-dimensions"></a>ディメンションを取得する
Dynamics 365 Business Central の**dimensions**オブジェクトのプロパティとリレーションシップを取得します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で**dimensions**オブジェクトを返します。
