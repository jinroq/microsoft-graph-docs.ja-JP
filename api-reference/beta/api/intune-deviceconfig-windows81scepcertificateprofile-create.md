...
要求の本文に windows81SCEPCertificateProfile オブジェクトの JSON の形式を指定します。

次の表は、windows81SCEPCertificateProfile を作成するときに必要なプロパティを示します。
...
かどうかは成功すると、このメソッドが返されます、`201 Created`応答コードおよび応答の本文に[windows81SCEPCertificateProfile](../resources/intune-deviceconfig-windows81scepcertificateprofile.md)オブジェクトです。
