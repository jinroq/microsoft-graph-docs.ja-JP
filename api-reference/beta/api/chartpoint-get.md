...
---
# <a name="get-chartpoint"></a>Get ChartPoint

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

chartPoint オブジェクトのプロパティと関係を取得します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[workbookChartPoint](../resources/workbookchartpoint.md)オブジェクトを返します。
## <a name="example"></a>例
##### <a name="request"></a>要求
以下は、要求の例です。
