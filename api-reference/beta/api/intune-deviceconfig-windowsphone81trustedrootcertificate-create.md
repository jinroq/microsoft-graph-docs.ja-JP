...
## <a name="http-request"></a><span data-ttu-id="4d4d3-118">HTTP 要求</span><span class="sxs-lookup"><span data-stu-id="4d4d3-118">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
