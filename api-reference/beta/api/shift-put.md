...
---
# <a name="replace-shift"></a>Shift を置換する

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

既存の[稼働時間帯](../resources/shift.md)を置き換えます。

指定した[シフト](../resources/shift.md)が存在しない場合、 `404 Not found`このメソッドはを返します。
...
要求本文で、 [shift](../resources/shift.md)オブジェクトの JSON 表記を指定します。
