...
<span data-ttu-id="20c49-176">以下は、要求の例です。</span><span class="sxs-lookup"><span data-stu-id="20c49-176">Here is an example of the request.</span></span>
``` http
