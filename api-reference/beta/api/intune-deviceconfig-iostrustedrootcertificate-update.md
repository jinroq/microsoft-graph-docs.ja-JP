...
---
# <a name="update-iostrustedrootcertificate"></a>iosTrustedRootCertificate の更新
...
要求本文で、 [iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md)オブジェクトの JSON 表記を指定します。

次の表に、 [iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md)の作成時に必要なプロパティを示します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で更新された[iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md)オブジェクトを返します。
