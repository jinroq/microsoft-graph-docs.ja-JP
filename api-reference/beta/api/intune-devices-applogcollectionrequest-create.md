...
---
# <a name="create-applogcollectionrequest"></a>AppLogCollectionRequest を作成します。
...
要求の本文に appLogCollectionRequest オブジェクトの JSON の形式を指定します。

次の表は、appLogCollectionRequest を作成するときに必要なプロパティを示します。
...
かどうかは成功すると、このメソッドが返されます、`201 Created`応答コードおよび応答の本文に[appLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md)オブジェクトです。
