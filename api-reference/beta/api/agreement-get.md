...
---
# <a name="get-agreement"></a>契約を取得します。

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

プロパティと[契約](../resources/agreement.md)オブジェクトの関係を取得します。
...
かどうかは成功すると、このメソッドが返されます、 `200 OK` 、応答の本体で応答コードおよび[契約](../resources/agreement.md)のオブジェクトです。
## <a name="example"></a>例
##### <a name="request"></a>要求
<!-- {
  "blockType": "request",
