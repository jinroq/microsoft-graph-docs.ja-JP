...
---
# <a name="list-devicemanagementsettingdefinitions"></a>devicemanagementsettingdefinitions のリスト
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[devicemanagementsettingdefinition](../resources/intune-deviceintent-devicemanagementsettingdefinition.md)オブジェクトのコレクションを返します。
