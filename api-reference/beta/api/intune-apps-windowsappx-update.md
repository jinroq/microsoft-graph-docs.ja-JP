...
---
# <a name="update-windowsappx"></a>WindowsAppX を更新します。
...
要求の本文に[windowsAppX](../resources/intune-apps-windowsappx.md)オブジェクトの JSON の形式を指定します。

[WindowsAppX](../resources/intune-apps-windowsappx.md)を作成するときに必要なプロパティを次の表に示します。
...
かどうかは成功すると、このメソッドが返されます、`200 OK`応答コードおよび応答の本文に更新された[windowsAppX](../resources/intune-apps-windowsappx.md)オブジェクトです。
