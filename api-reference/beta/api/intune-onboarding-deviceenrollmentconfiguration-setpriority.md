...
---
# <a name="setpriority-action"></a><span data-ttu-id="a03d1-103">setPriority アクション</span><span class="sxs-lookup"><span data-stu-id="a03d1-103">setPriority action</span></span>
...
<span data-ttu-id="a03d1-106">まだ文書化されていません</span><span class="sxs-lookup"><span data-stu-id="a03d1-106">Not yet documented</span></span>
...
|:---|:---|
|<span data-ttu-id="a03d1-112">委任 (職場または学校のアカウント)</span><span class="sxs-lookup"><span data-stu-id="a03d1-112">Delegated (work or school account)</span></span>|<span data-ttu-id="a03d1-113">DeviceManagementServiceConfig.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="a03d1-113">DeviceManagementServiceConfig.ReadWrite.All</span></span>|
...
<span data-ttu-id="a03d1-127">要求本文で、パラメーターの JSON 表記を指定します。</span><span class="sxs-lookup"><span data-stu-id="a03d1-127">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="a03d1-128">次の表に、このアクションで使用できるパラメーターを示します。</span><span class="sxs-lookup"><span data-stu-id="a03d1-128">The following table shows the parameters that can be used with this action.</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="a03d1-132">priority</span><span class="sxs-lookup"><span data-stu-id="a03d1-132">priority</span></span>|<span data-ttu-id="a03d1-133">Int32</span><span class="sxs-lookup"><span data-stu-id="a03d1-133">Int32</span></span>|<span data-ttu-id="a03d1-134">まだ文書化されていません</span><span class="sxs-lookup"><span data-stu-id="a03d1-134">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="a03d1-135">応答</span><span class="sxs-lookup"><span data-stu-id="a03d1-135">Response</span></span>
<span data-ttu-id="a03d1-136">成功した場合、このアクションは `204 No Content` 応答コードを返します。</span><span class="sxs-lookup"><span data-stu-id="a03d1-136">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="a03d1-137">例</span><span class="sxs-lookup"><span data-stu-id="a03d1-137">Example</span></span>

### <a name="request"></a><span data-ttu-id="a03d1-138">要求</span><span class="sxs-lookup"><span data-stu-id="a03d1-138">Request</span></span>
<span data-ttu-id="a03d1-139">以下は、要求の例です。</span><span class="sxs-lookup"><span data-stu-id="a03d1-139">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="a03d1-140">応答</span><span class="sxs-lookup"><span data-stu-id="a03d1-140">Response</span></span>
<span data-ttu-id="a03d1-p102">以下は、応答の例です。注:簡潔にするために、ここに示す応答オブジェクトは切り詰められている場合があります。すべてのプロパティは実際の呼び出しから返されます。</span><span class="sxs-lookup"><span data-stu-id="a03d1-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
