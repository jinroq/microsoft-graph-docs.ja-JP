...
---
# <a name="create-windows10pfximportcertificateprofile"></a>Windows10PFXImportCertificateProfile を作成します。
...
要求の本文に windows10PFXImportCertificateProfile オブジェクトの JSON の形式を指定します。

次の表は、windows10PFXImportCertificateProfile を作成するときに必要なプロパティを示します。
...
かどうかは成功すると、このメソッドが返されます、`201 Created`応答コードおよび応答の本文に[windows10PFXImportCertificateProfile](../resources/intune-deviceconfig-windows10pfximportcertificateprofile.md)オブジェクトです。
