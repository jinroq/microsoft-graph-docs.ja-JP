...
ms.locfileid: "34969170"
---
# <a name="delete-androidworkprofilepkcscertificateprofile"></a><span data-ttu-id="65686-103">AndroidWorkProfilePkcsCertificateProfile の削除</span><span class="sxs-lookup"><span data-stu-id="65686-103">Delete androidWorkProfilePkcsCertificateProfile</span></span>
...
<span data-ttu-id="65686-106">[AndroidWorkProfilePkcsCertificateProfile](../resources/intune-deviceconfig-androidworkprofilepkcscertificateprofile.md)を削除します。</span><span class="sxs-lookup"><span data-stu-id="65686-106">Deletes a [androidWorkProfilePkcsCertificateProfile](../resources/intune-deviceconfig-androidworkprofilepkcscertificateprofile.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="65686-112">委任 (職場または学校のアカウント)</span><span class="sxs-lookup"><span data-stu-id="65686-112">Delegated (work or school account)</span></span>|<span data-ttu-id="65686-113">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="65686-113">DeviceManagementConfiguration.ReadWrite.All</span></span>|
