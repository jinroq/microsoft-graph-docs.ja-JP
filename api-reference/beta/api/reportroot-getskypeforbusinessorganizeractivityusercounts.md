...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で**[Skypeforbusinessオーガナイザー Eractivityuser計数](../resources/skypeforbusinessorganizeractivityusercounts.md)** オブジェクトを返します。
