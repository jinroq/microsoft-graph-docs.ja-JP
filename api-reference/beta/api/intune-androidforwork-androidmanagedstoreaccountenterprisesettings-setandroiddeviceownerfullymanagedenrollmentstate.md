...
AndroidManagedStoreAccountEnterpriseSettings AndroidDeviceOwnerFullyManagedEnrollmentEnabled を指定した値に設定します。
...
|プロパティ|型|説明|
|:---|:---|:---|
|enabled|Boolean|AndroidDeviceOwnerFullyManagedEnrollmentEnabled に設定する値です。|
