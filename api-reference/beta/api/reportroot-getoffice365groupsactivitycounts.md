...
- レポートの更新日
- 受信した Exchange の電子メール
- 投稿された Yammer メッセージ
- 読み取られた Yammer メッセージ
- 「いいね!」された Yammer メッセージ
- レポート日付
- レポート期間
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で**[office365GroupsActivityCounts](../resources/office365groupsactivitycounts.md)** オブジェクトを返します。

**[Office365GroupsActivityCounts](../resources/office365groupsactivitycounts.md)** オブジェクトの次のプロパティは、21vianet が運用している Microsoft Graph の中国ではサポートされていません。
