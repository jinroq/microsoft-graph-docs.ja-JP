---
title: 'デバイス: checkMemberObjects'
description: 指定したデバイスオブジェクトのグループ、ディレクトリの役割、または管理単位の一覧のメンバーシップを確認します。
...
ms.locfileid: "36853869"
---
# <a name="device-checkmemberobjects"></a>デバイス: checkMemberObjects

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

指定したデバイスオブジェクトのグループまたは管理単位の一覧のメンバーシップを確認します。 このメソッドは推移的です。
