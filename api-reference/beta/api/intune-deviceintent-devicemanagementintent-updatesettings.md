...
---
# <a name="updatesettings-action"></a>updateSettings アクション
...
|プロパティ|型|説明|
|:---|:---|:---|
|settings|[Devicemanagementsettinginstance](../resources/intune-deviceintent-devicemanagementsettinginstance.md)コレクション|まだ文書化されていません|
