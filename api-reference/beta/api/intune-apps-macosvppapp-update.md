...
要求本文で、 [macOsVppApp](../resources/intune-apps-macosvppapp.md)オブジェクトの JSON 表記を指定します。

次の表に、 [macOsVppApp](../resources/intune-apps-macosvppapp.md)の作成時に必要なプロパティを示します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で更新された[macOsVppApp](../resources/intune-apps-macosvppapp.md)オブジェクトを返します。
