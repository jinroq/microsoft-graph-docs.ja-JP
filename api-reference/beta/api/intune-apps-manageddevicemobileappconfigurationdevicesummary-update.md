...
## <a name="http-request"></a><span data-ttu-id="dd7e6-118">HTTP 要求</span><span class="sxs-lookup"><span data-stu-id="dd7e6-118">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
