...
---
# <a name="create-macoslobapp"></a>MacOSLobApp を作成します。
...
要求の本文に macOSLobApp オブジェクトの JSON の形式を指定します。

次の表は、macOSLobApp を作成するときに必要なプロパティを示します。
...
かどうかは成功すると、このメソッドが返されます、`201 Created`応答コードおよび応答の本文に[macOSLobApp](../resources/intune-apps-macoslobapp.md)オブジェクトです。
