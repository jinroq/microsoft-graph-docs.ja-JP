...
---
# <a name="getrolescopetagsbyid-action"></a>getRoleScopeTagsById アクション
...
成功した場合、このアクション`200 OK`は応答コードと、応答本文で[ロール copetag](../resources/intune-rbac-rolescopetag.md)コレクションを返します。
