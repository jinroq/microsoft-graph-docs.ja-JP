...
ms.locfileid: "36791254"
---
# <a name="get-taxareas"></a>TaxAreas を取得する
Dynamics 365 Business Central の税エリアオブジェクトのプロパティとリレーションシップを取得します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で**taxAreas**オブジェクトを返します。
