...
## <a name="http-request"></a><span data-ttu-id="afe00-118">HTTP 要求</span><span class="sxs-lookup"><span data-stu-id="afe00-118">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
