...
---
# <a name="get-devicemanagementscriptuserstate"></a>devicemanagementscriptuserstate の取得
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[devicemanagementscriptuserstate](../resources/intune-devices-devicemanagementscriptuserstate.md)オブジェクトを返します。
