...
---
# <a name="get-rolescopetagautoassignment"></a>ロールの Copetagautoassignment の取得
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[ロール Copetagautoassignment](../resources/intune-rbac-rolescopetagautoassignment.md)オブジェクトを返します。
