...
---
# <a name="update-publishedresource"></a>PublishedResource の更新

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Publishedresource [Publishedresource](../resources/publishedresource.md)オブジェクトのプロパティを更新します。
...
| プロパティ     | 型        | 説明 |
|:-------------|:------------|:------------|
|displayName|String|オンプレミスで発行されたリソース名を表します。|
