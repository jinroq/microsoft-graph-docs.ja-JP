...
ms.locfileid: "36721776"
---
# <a name="list-rubrics"></a>リストを表示する (ics)

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

[EducationRubric](../resources/educationrubric.md)オブジェクトのリストを取得します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[educationRubric](../resources/educationrubric.md)オブジェクトのコレクションを返します。
