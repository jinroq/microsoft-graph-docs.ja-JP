...
---
# <a name="update-customerpaymentjournals"></a>customerPaymentJournals の更新
Dynamics 365 Business Central の顧客支払仕訳帳オブジェクトのプロパティを更新します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で更新された**customerPaymentJournals**オブジェクトを返します。
