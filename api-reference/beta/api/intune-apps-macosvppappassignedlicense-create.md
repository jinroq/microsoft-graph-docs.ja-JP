...
---
# <a name="create-macosvppappassignedlicense"></a>MacOsVppAppAssignedLicense を作成します。
...
要求の本文に macOsVppAppAssignedLicense オブジェクトの JSON の形式を指定します。

次の表は、macOsVppAppAssignedLicense を作成するときに必要なプロパティを示します。
...
かどうかは成功すると、このメソッドが返されます、`201 Created`応答コードおよび応答の本文に[macOsVppAppAssignedLicense](../resources/intune-apps-macosvppappassignedlicense.md)オブジェクトです。
