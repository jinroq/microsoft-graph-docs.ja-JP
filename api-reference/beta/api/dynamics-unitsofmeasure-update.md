...
---
# <a name="update-unitsofmeasure"></a>unitsOfMeasure の更新
Dynamics 365 Business Central の測定単位オブジェクトのプロパティを更新します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で更新された**unitsOfMeasure**オブジェクトを返します。
