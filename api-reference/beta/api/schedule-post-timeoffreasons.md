...
---
# <a name="create-timeoffreason"></a>TimeOffReason の作成

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

新しい[Timeoffreason](../resources/timeoffreason.md)を作成します。
...
成功した場合、このメソッド`201 Created`は応答コードと、応答本文で[timeoffreason](../resources/timeoffreason.md)オブジェクトを返します。
