...
---
# <a name="updatestatus-action"></a>updateStatus アクション
...
|プロパティ|型|説明|
|:---|:---|:---|
|status|[deviceAppManagementTaskStatus](../resources/intune-partnerintegration-deviceappmanagementtaskstatus.md)|状態|
|こと|String|メモ|
