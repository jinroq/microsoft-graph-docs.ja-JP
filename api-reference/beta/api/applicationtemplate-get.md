...
ms.locfileid: "36719004"
---
# <a name="get-applicationtemplate"></a>ApplicationTemplate の取得

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

[Applicationtemplate](../resources/applicationtemplate.md)オブジェクトのプロパティを取得します。
...
`$select`クエリパラメーターを使用して、最適なパフォーマンスを得るために必要なプロパティのみを指定することができます。 **Id**プロパティは常に返されます。 
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で要求された[applicationtemplate](../resources/applicationtemplate.md)オブジェクトを返します。
