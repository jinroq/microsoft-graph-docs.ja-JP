...
---
# <a name="create-chatmessage-in-a-channel"></a>チャネルでの chatMessage の作成

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

指定した[チャネル](../resources/channel.md)で新しい[chatmessage](../resources/chatmessage.md)を作成します。
...
### <a name="example-3-cards"></a>例 3: カード
...
- [カードリファレンス](https://docs.microsoft.com/en-us/microsoftteams/platform/concepts/cards/cards-reference)
