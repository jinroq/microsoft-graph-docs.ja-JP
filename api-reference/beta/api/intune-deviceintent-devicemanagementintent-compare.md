...
---
# <a name="compare-function"></a>compare 関数
...
|プロパティ|型|説明|
|:---|:---|:---|
|templateId|String|まだ文書化されていません|



## <a name="response"></a>応答
成功した場合、この関数`200 OK`は応答コードと、応答本文で[Devicemanagementsettingcomparison](../resources/intune-deviceintent-devicemanagementsettingcomparison.md)コレクションを返します。
