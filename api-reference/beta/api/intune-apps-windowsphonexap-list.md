...
ms.locfileid: "32488170"
---
# <a name="list-windowsphonexaps"></a><span data-ttu-id="a5383-103">リスト windowsPhoneXAPs</span><span class="sxs-lookup"><span data-stu-id="a5383-103">List windowsPhoneXAPs</span></span>
...
<span data-ttu-id="a5383-106">[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)オブジェクトのプロパティとリレーションシップをリストします。</span><span class="sxs-lookup"><span data-stu-id="a5383-106">List properties and relationships of the [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) objects.</span></span>
...
|:---|:---|
|<span data-ttu-id="a5383-112">委任 (職場または学校のアカウント)</span><span class="sxs-lookup"><span data-stu-id="a5383-112">Delegated (work or school account)</span></span>|<span data-ttu-id="a5383-113">DeviceManagementApps.ReadWrite.All、DeviceManagementApps.Read.All</span><span class="sxs-lookup"><span data-stu-id="a5383-113">DeviceManagementApps.ReadWrite.All, DeviceManagementApps.Read.All</span></span>|
...
|<span data-ttu-id="a5383-116">アプリケーション</span><span class="sxs-lookup"><span data-stu-id="a5383-116">Application</span></span>|<span data-ttu-id="a5383-117">サポートされていません。</span><span class="sxs-lookup"><span data-stu-id="a5383-117">Not supported.</span></span>|
...
<span data-ttu-id="a5383-127">このメソッドには、要求本文を指定しません。</span><span class="sxs-lookup"><span data-stu-id="a5383-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="a5383-128">応答</span><span class="sxs-lookup"><span data-stu-id="a5383-128">Response</span></span>
<span data-ttu-id="a5383-129">成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)オブジェクトのコレクションを返します。</span><span class="sxs-lookup"><span data-stu-id="a5383-129">If successful, this method returns a `200 OK` response code and a collection of [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) objects in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="a5383-130">例</span><span class="sxs-lookup"><span data-stu-id="a5383-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="a5383-131">要求</span><span class="sxs-lookup"><span data-stu-id="a5383-131">Request</span></span>
<span data-ttu-id="a5383-132">以下は、要求の例です。</span><span class="sxs-lookup"><span data-stu-id="a5383-132">Here is an example of the request.</span></span>
``` http
GET https://graph.microsoft.com/beta/deviceAppManagement/mobileApps
```

### <a name="response"></a><span data-ttu-id="a5383-133">応答</span><span class="sxs-lookup"><span data-stu-id="a5383-133">Response</span></span>
<span data-ttu-id="a5383-p102">以下は、応答の例です。注:簡潔にするために、ここに示す応答オブジェクトは切り詰められている場合があります。すべてのプロパティは実際の呼び出しから返されます。</span><span class="sxs-lookup"><span data-stu-id="a5383-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
HTTP/1.1 200 OK
