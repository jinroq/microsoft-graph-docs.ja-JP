...
ms.locfileid: "36791471"
---
# <a name="get-journals"></a>ジャーナルを取得する
Dynamics 365 Business Central の journal オブジェクトのプロパティとリレーションシップを取得します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で**ジャーナル**オブジェクトを返します。
