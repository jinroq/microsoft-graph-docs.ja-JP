...
---
# <a name="create-macosimportedpfxcertificateprofile"></a>MacOSImportedPFXCertificateProfile を作成します。
...
要求の本文に macOSImportedPFXCertificateProfile オブジェクトの JSON の形式を指定します。

次の表は、macOSImportedPFXCertificateProfile を作成するときに必要なプロパティを示します。
...
かどうかは成功すると、このメソッドが返されます、`201 Created`応答コードおよび応答の本文に[macOSImportedPFXCertificateProfile](../resources/intune-deviceconfig-macosimportedpfxcertificateprofile.md)オブジェクトです。
