...
---
# <a name="create-intunebrandingprofileassignment"></a>IntuneBrandingProfileAssignment を作成します。
...
要求の本文に intuneBrandingProfileAssignment オブジェクトの JSON の形式を指定します。

次の表は、intuneBrandingProfileAssignment を作成するときに必要なプロパティを示します。
...
かどうかは成功すると、このメソッドが返されます、`201 Created`応答コードおよび応答の本文に[intuneBrandingProfileAssignment](../resources/intune-wip-intunebrandingprofileassignment.md)オブジェクトです。
