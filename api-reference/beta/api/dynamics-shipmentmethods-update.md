...
ms.locfileid: "36791310"
---
# <a name="update-shipmentmethods"></a>ShipmentMethods の更新
Dynamics 365 Business Central の送付方法オブジェクトのプロパティを更新します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で更新された**shipmentMethods**オブジェクトを返します。
