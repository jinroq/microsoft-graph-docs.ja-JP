...
---
# <a name="remove-publishedresource-from-an-onpremisesagentgroup"></a>OnPremisesAgentGroup から publishedResource を削除する

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

[OnPremisesAgentGroup](../resources/onpremisesagentgroup.md)オブジェクトから[publishedresource](../resources/publishedresource.md)オブジェクトを削除します。
