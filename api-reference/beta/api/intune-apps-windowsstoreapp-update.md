...
---
# <a name="update-windowsstoreapp"></a>windowsstoreapp の更新
...
要求本文で、 [windowsstoreapp](../resources/intune-apps-windowsstoreapp.md)オブジェクトの JSON 表記を指定します。

次の表に、 [windowsstoreapp](../resources/intune-apps-windowsstoreapp.md)の作成時に必要なプロパティを示します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で更新された[windowsstoreapp](../resources/intune-apps-windowsstoreapp.md)オブジェクトを返します。
