...
---
# <a name="update-workbookchartaxistitle"></a>workbookChartAxisTitle の更新

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

workbookChartAxisTitle オブジェクトのプロパティを更新します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で、更新された[workbookChartAxisTitle](../resources/workbookchartaxistitle.md)オブジェクトを返します。
## <a name="example"></a>例
##### <a name="request"></a>要求
以下は、要求の例です。
<!-- {
