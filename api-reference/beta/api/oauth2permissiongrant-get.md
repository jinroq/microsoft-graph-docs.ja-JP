...
プロパティと oAuth2Permissiongrant オブジェクトの関係を取得します。
...
かどうかは成功すると、このメソッドが返されます、 `200 OK` 、応答の本体で応答コードと[oAuth2Permissiongrant](../resources/oauth2permissiongrant.md)のオブジェクトです。
## <a name="example"></a>例
##### <a name="request"></a>要求
以下は、要求の例です。
<!-- {
