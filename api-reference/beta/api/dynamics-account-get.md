...
---
# <a name="get-accounts"></a>アカウントを取得する
Dynamics 365 Business Central の account オブジェクトのプロパティとリレーションシップを取得します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で**accounts**オブジェクトを返します。
