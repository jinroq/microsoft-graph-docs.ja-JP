...
ms.locfileid: "36723309"
---
# <a name="list-publishedresources"></a>PublishedResources のリスト

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

[Publishedresource](../resources/publishedresource.md)オブジェクトのリストを取得します。
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[publishedresource](../resources/publishedresource.md)オブジェクトのコレクションを返します。
