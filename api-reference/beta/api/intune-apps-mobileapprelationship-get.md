...
---
# <a name="get-mobileapprelationship"></a>mobileAppRelationship を取得する
...
成功した場合、このメソッド`200 OK`は応答コードと、応答本文で[mobileAppRelationship](../resources/intune-apps-mobileapprelationship.md)オブジェクトを返します。
