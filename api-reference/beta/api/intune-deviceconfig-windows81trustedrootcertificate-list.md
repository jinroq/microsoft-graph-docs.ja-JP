...
ms.locfileid: "27074019"
---
# <a name="list-windows81trustedrootcertificates"></a><span data-ttu-id="4c0bb-103">リスト windows81TrustedRootCertificates</span><span class="sxs-lookup"><span data-stu-id="4c0bb-103">List windows81TrustedRootCertificates</span></span>
...
<span data-ttu-id="4c0bb-107">[Windows81TrustedRootCertificate](../resources/intune-deviceconfig-windows81trustedrootcertificate.md)オブジェクトのプロパティと関係を一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="4c0bb-107">List properties and relationships of the [windows81TrustedRootCertificate](../resources/intune-deviceconfig-windows81trustedrootcertificate.md) objects.</span></span>
...
|:---|:---|
|<span data-ttu-id="4c0bb-113">委任 (職場または学校のアカウント)</span><span class="sxs-lookup"><span data-stu-id="4c0bb-113">Delegated (work or school account)</span></span>|<span data-ttu-id="4c0bb-114">DeviceManagementConfiguration.ReadWrite.All、DeviceManagementConfiguration.Read.All</span><span class="sxs-lookup"><span data-stu-id="4c0bb-114">DeviceManagementConfiguration.ReadWrite.All, DeviceManagementConfiguration.Read.All</span></span>|
...
<span data-ttu-id="4c0bb-128">このメソッドには、要求本文を指定しません。</span><span class="sxs-lookup"><span data-stu-id="4c0bb-128">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="4c0bb-129">応答</span><span class="sxs-lookup"><span data-stu-id="4c0bb-129">Response</span></span>
<span data-ttu-id="4c0bb-130">かどうかは成功すると、このメソッドが返されます、`200 OK`応答コードおよび応答の本文に[windows81TrustedRootCertificate](../resources/intune-deviceconfig-windows81trustedrootcertificate.md)オブジェクトのコレクションです。</span><span class="sxs-lookup"><span data-stu-id="4c0bb-130">If successful, this method returns a `200 OK` response code and a collection of [windows81TrustedRootCertificate](../resources/intune-deviceconfig-windows81trustedrootcertificate.md) objects in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="4c0bb-131">例</span><span class="sxs-lookup"><span data-stu-id="4c0bb-131">Example</span></span>
### <a name="request"></a><span data-ttu-id="4c0bb-132">要求</span><span class="sxs-lookup"><span data-stu-id="4c0bb-132">Request</span></span>
<span data-ttu-id="4c0bb-133">以下は、要求の例です。</span><span class="sxs-lookup"><span data-stu-id="4c0bb-133">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="4c0bb-134">応答</span><span class="sxs-lookup"><span data-stu-id="4c0bb-134">Response</span></span>
<span data-ttu-id="4c0bb-p103">以下は、応答の例です。注:簡潔にするために、ここに示す応答オブジェクトは切り詰められている場合があります。すべてのプロパティは実際の呼び出しから返されます。</span><span class="sxs-lookup"><span data-stu-id="4c0bb-p103">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
HTTP/1.1 200 OK
