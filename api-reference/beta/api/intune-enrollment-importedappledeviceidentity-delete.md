...
---
# <a name="delete-importedappledeviceidentity"></a><span data-ttu-id="0cabe-103">ImportedAppleDeviceIdentity の削除</span><span class="sxs-lookup"><span data-stu-id="0cabe-103">Delete importedAppleDeviceIdentity</span></span>
...
<span data-ttu-id="0cabe-106">[ImportedAppleDeviceIdentity](../resources/intune-enrollment-importedappledeviceidentity.md)を削除します。</span><span class="sxs-lookup"><span data-stu-id="0cabe-106">Deletes a [importedAppleDeviceIdentity](../resources/intune-enrollment-importedappledeviceidentity.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="0cabe-112">委任 (職場または学校のアカウント)</span><span class="sxs-lookup"><span data-stu-id="0cabe-112">Delegated (work or school account)</span></span>|<span data-ttu-id="0cabe-113">DeviceManagementServiceConfig.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="0cabe-113">DeviceManagementServiceConfig.ReadWrite.All</span></span>|
...
<span data-ttu-id="0cabe-127">このメソッドには、要求本文を指定しません。</span><span class="sxs-lookup"><span data-stu-id="0cabe-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="0cabe-128">応答</span><span class="sxs-lookup"><span data-stu-id="0cabe-128">Response</span></span>
<span data-ttu-id="0cabe-129">成功した場合、このメソッドは `204 No Content` 応答コードを返します。</span><span class="sxs-lookup"><span data-stu-id="0cabe-129">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="0cabe-130">例</span><span class="sxs-lookup"><span data-stu-id="0cabe-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="0cabe-131">要求</span><span class="sxs-lookup"><span data-stu-id="0cabe-131">Request</span></span>
<span data-ttu-id="0cabe-132">以下は、要求の例です。</span><span class="sxs-lookup"><span data-stu-id="0cabe-132">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="0cabe-133">応答</span><span class="sxs-lookup"><span data-stu-id="0cabe-133">Response</span></span>
<span data-ttu-id="0cabe-p102">以下は、応答の例です。注:簡潔にするために、ここに示す応答オブジェクトは切り詰められている場合があります。すべてのプロパティは実際の呼び出しから返されます。</span><span class="sxs-lookup"><span data-stu-id="0cabe-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
