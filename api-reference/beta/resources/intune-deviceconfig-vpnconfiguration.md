...
---
# <a name="vpnconfiguration-resource-type"></a>vpnConfiguration リソースの種類
...
|メソッド|戻り値の型|説明|
|:---|:---|:---|
|[VpnConfigurations を一覧表示する](../api/intune-deviceconfig-vpnconfiguration-list.md)|[Vpnconfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)コレクション|[Vpnconfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)オブジェクトのプロパティとリレーションシップをリストします。|
|[VpnConfiguration の取得](../api/intune-deviceconfig-vpnconfiguration-get.md)|[vpnConfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)|[Vpnconfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)オブジェクトのプロパティとリレーションシップを読み取ります。|
