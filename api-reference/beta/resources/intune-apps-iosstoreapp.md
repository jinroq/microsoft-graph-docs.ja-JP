...
|メソッド|戻り値の型|説明|
|:---|:---|:---|
|[iosStoreApps のリスト](../api/intune-apps-iosstoreapp-list.md)|[iosStoreApp](../resources/intune-apps-iosstoreapp.md) コレクション|[iosStoreApp](../resources/intune-apps-iosstoreapp.md) オブジェクトのプロパティとリレーションシップをリストします。|
...
|[iosStoreApp の作成](../api/intune-apps-iosstoreapp-create.md)|[iosStoreApp](../resources/intune-apps-iosstoreapp.md)|新しい [iosStoreApp](../resources/intune-apps-iosstoreapp.md) オブジェクトを作成します。|
|[iosStoreApp の削除](../api/intune-apps-iosstoreapp-delete.md)|なし|[iosStoreApp](../resources/intune-apps-iosstoreapp.md) を削除します。|
