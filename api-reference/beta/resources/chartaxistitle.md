...
| メソッド           | 戻り値の型    |説明|
|:---------------|:--------|:----------|
|Get ChartAxisTitle | [chartAxisTitle](chartaxistitle.md) |chartAxisTitle オブジェクトのプロパティと関係を読み取ります。|
|[Update](../api/chartaxistitle-update.md) | ChartAxisTitle    |ChartAxisTitle オブジェクトを更新します。 |
