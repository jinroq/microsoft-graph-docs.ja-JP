...
| メソッド       | 戻り値の型  |説明|
|:---------------|:--------|:----------|
|ユーザー設定を取得する |設定| ユーザーと組織の設定を取得します。 |
|[ユーザー設定の更新](../api/user-update-settings.md) |設定| ユーザーの現在の設定を更新します。 |
