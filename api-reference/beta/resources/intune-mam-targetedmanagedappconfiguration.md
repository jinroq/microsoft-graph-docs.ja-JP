...
|[assign action](../api/intune-mam-targetedmanagedappconfiguration-assign.md)|None|まだ文書化されていません|
|[targetApps action](../api/intune-mam-targetedmanagedappconfiguration-targetapps.md)|None|まだ文書化されていません|
