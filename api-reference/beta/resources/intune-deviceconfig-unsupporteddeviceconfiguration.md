...
UnsupportedDeviceConfiguration は、deviceConfiguration の別のモデルに準拠したサブタイプにエンティティをマッピングできない場合に使用されます。
