...
|メソッド|戻り値の型|説明|
|:---|:---|:---|
|[windowsUniversalAppXs のリスト](../api/intune-apps-windowsuniversalappx-list.md)|[windowsUniversalAppX](../resources/intune-apps-windowsuniversalappx.md) コレクション|[windowsUniversalAppX](../resources/intune-apps-windowsuniversalappx.md) オブジェクトのプロパティとリレーションシップをリストします。|
...
|[windowsUniversalAppX の更新](../api/intune-apps-windowsuniversalappx-update.md)|[windowsUniversalAppX](../resources/intune-apps-windowsuniversalappx.md)|[windowsUniversalAppX](../resources/intune-apps-windowsuniversalappx.md) オブジェクトのプロパティを更新します。|
...
|committedContainedApps|[mobileContainedApp](../resources/intune-apps-mobilecontainedapp.md)コレクション|windowsUniversalAppX アプリのコミットされた mobileAppContent に含まれているアプリのコレクション。|
