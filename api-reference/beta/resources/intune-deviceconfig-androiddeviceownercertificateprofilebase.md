...
---
# <a name="androiddeviceownercertificateprofilebase-resource-type"></a>androidDeviceOwnerCertificateProfileBase リソースの種類

> **重要:** ベータ版の Microsoft Graph Api は変更される可能性があります。運用環境での使用はサポートされていません。

> **注:** Microsoft Graph API for Intune では、テナントに対して[アクティブな intune ライセンス](https://go.microsoft.com/fwlink/?linkid=839381)が必要です。

Android デバイス所有者の証明書プロファイルベース。
...
|メソッド|戻り値の型|説明|
|:---|:---|:---|
|[リスト androiddeviceownercertificateprofileid](../api/intune-deviceconfig-androiddeviceownercertificateprofilebase-list.md)|[Androiddeviceownercertificateprofilebase](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md)コレクション|[Androiddeviceownercertificateprofilebase](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md)オブジェクトのプロパティとリレーションシップをリストします。|
|[AndroidDeviceOwnerCertificateProfileBase を取得する](../api/intune-deviceconfig-androiddeviceownercertificateprofilebase-get.md)|[androidDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md)|[Androiddeviceownercertificateprofilebase](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md)オブジェクトのプロパティとリレーションシップを読み取ります。|
...
|rootCertificate|[androidDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-androiddeviceownertrustedrootcertificate.md)|信頼されたルート証明書。|
