...
ms.locfileid: "32542327"
---
# <a name="filtercriteria-resource-type"></a><span data-ttu-id="9ca20-103">FilterCriteria リソースの種類</span><span class="sxs-lookup"><span data-stu-id="9ca20-103">FilterCriteria resource type</span></span>

<span data-ttu-id="9ca20-104">列に適用するフィルター条件を表します。</span><span class="sxs-lookup"><span data-stu-id="9ca20-104">Represents the filtering criteria applied to a column.</span></span>

## <a name="json-representation"></a><span data-ttu-id="9ca20-105">JSON 表記</span><span class="sxs-lookup"><span data-stu-id="9ca20-105">JSON representation</span></span>

<span data-ttu-id="9ca20-106">以下は、リソースの JSON 表記です。</span><span class="sxs-lookup"><span data-stu-id="9ca20-106">Here is a JSON representation of the resource.</span></span>
