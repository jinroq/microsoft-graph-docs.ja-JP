...
|メソッド|戻り値の型|説明|
|:---|:---|:---|
|[mdmWindowsInformationProtectionPolicies のリスト](../api/intune-mam-mdmwindowsinformationprotectionpolicy-list.md)|[mdmWindowsInformationProtectionPolicy](../resources/intune-mam-mdmwindowsinformationprotectionpolicy.md) コレクション|[mdmWindowsInformationProtectionPolicy](../resources/intune-mam-mdmwindowsinformationprotectionpolicy.md) オブジェクトのプロパティとリレーションシップをリストします。|
...
|[mdmWindowsInformationProtectionPolicy の削除](../api/intune-mam-mdmwindowsinformationprotectionpolicy-delete.md)|なし|[mdmWindowsInformationProtectionPolicy](../resources/intune-mam-mdmwindowsinformationprotectionpolicy.md) を削除します。|
