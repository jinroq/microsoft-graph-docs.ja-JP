...
|[Get iosVppEBook](../api/intune-books-iosvppebook-get.md)|[iosVppEBook](../resources/intune-books-iosvppebook.md)|[iosVppEBook](../resources/intune-books-iosvppebook.md) オブジェクトのプロパティとリレーションシップを読み取ります。|
...
|[Delete iosVppEBook](../api/intune-books-iosvppebook-delete.md)|なし|[iosVppEBook](../resources/intune-books-iosvppebook.md) を削除します。|
