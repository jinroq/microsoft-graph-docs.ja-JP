...
MacOS ゲートキーパーのアプリケーション ソースのオプションです。
## <a name="members"></a>メンバー
|メンバー|値|説明|
|:---|:---|:---|
|notConfigured|0|デバイスの既定値でことを目的しません。|
|macAppStore|1|Mac AppStore からのアプリのみを実行することができます。|
|macAppStoreAndIdentifiedDevelopers|2|Mac AppStore と識別された開発者からの唯一のアプリケーションを実行することができます。|
|任意の場所|3|任意の場所からアプリケーションを実行することができます。|
