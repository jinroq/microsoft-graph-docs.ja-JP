...
| [分析を取得します。][]                                        | `GET /drive/items/{item-id}/analytics`
| [間隔によってアクティビティを取得します。][]                           | `GET /drive/items/{item-id}/getActivitiesByInterval`
...
| [WebSocket のチャネルを取得します。][getWebSocket]                    | `GET /drive/root/subscriptions/socketIo`
