...
|identity certificateforclientauthentication|[iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|シングルサインオン設定で使用される Kerberos チケットの更新用の id 証明書。|
