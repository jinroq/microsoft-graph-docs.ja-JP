...
|enablesplittunneling|ブール値|VPN の分割トンネリングを有効にします。 [windows81VpnConfiguration](../resources/intune-deviceconfig-windows81vpnconfiguration.md)から継承します。|
...
|bypassVpnOnHomeWifi|ブール値|自宅 wi-fi で VPN をバイパスします。|
