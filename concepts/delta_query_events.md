...
これらのトークンは、refs/remotes/microsoftgraph/master _startDateTime_ パラメーターと _endDateTime_ パラメーター、最初のデルタ クエリの GET 要求内の他のすべてのクエリ パラメーターをエンコードする[状態トークン](delta_query_overview.md#state-tokens)です。 
...
- [ユーザーへの増分の変更を取得する](../Concepts/delta_query_users.md)
