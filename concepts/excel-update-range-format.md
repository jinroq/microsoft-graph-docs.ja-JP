...
次の例は、指定された範囲の [RangeFormat](../api-reference/v1.0/resources/rangeformat.md)、[RangeFill](../api-reference/v1.0/resources/rangefill.md)、[RangeFont](../api-reference/v1.0/resources/rangefont.md) の各プロパティを更新する方法を示します。
