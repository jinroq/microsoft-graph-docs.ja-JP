...
* [アクティビティ フィード API](../api-reference/v1.0/resources/activity-feed-api-overview.md) を使用してすべてのプラットフォームからユーザー アクティビティを読み書きする
...
[Project Rome API](https://developer.microsoft.com/ja-JP/graph/docs/api-reference/v1.0/resources/project_rome_overview) を使用する、各アプリケーションおよびプラットフォームのプラットフォーム固有アプリケーション ID を収集します。
...
Microsoft Graph でアクティビティ フィード API を使用するアプリがある場合、ホスト値を **activitySourceHost** プロパティに指定する必要があります。 詳細については、「[アクティビティ リソース タイプ](https://developer.microsoft.com/ja-JP/graph/docs/api-reference/v1.0/resources/projectrome_activity)」を参照してください。
