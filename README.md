# <a name="microsoft-graph-documentation"></a>Microsoft Graph ドキュメント

Microsoft Graph ドキュメントにご関心をお寄せいただき、ありがとうございます。 最適にご利用いただくには、このコンテンツを [Microsoft Graph 開発者ポータル](https://docs.microsoft.com/graph)で表示することをお勧めします。
