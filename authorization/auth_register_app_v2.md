# <a name="register-your-microsoft-graph-application-with-the-azure-ad-v20-endpoint"></a>Microsoft Graph アプリケーションを Azure AD v2.0 エンドポイントに登録する
...
> **注:**この記事では、Azure AD v2.0 エンドポイントへのアプリ登録について説明します。[Azure AD にアプリを登録する](app_authorization.md)には、[Azure Portal](https://aka.ms/aadapplist) を使用します。
> 
